...
export default function JogoDaNaveSEO() {
  return (
    <Head>
      ...
      <meta key="ogUrl" property="og:url" content="https://devdiegomatos.com.br/trabalhos/jogo-da-nave"/>
      ...
      <meta key="twitterUrl" name="twitter:url" content="https://devdiegomatos.com.br/trabalhos/jogo-da-nave"/>
    </Head>
  )
}
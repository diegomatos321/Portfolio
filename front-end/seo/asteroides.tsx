...
export default function FlappyBirdSEO() {
  return (
        <Head>
          ...
          <link key="canonical" rel="canonical" href="https://devdiegomatos.com.br/trabalhos/jogo-asteroides"/>
          ...
          <meta key="ogUrl" property="og:url" content="https://devdiegomatos.com.br/trabalhos/jogo-asteroides"/>
          ...
          <meta key="twitterUrl" name="twitter:url" content="https://devdiegomatos.com.br/trabalhos/jogo-asteroides"/>
    </Head>
  )
}
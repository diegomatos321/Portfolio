...
export default function SuperMarioSEO() {
  return (
    <Head>
      ...
      <link key="canonical" rel="canonical" href="https://devdiegomatos.com.br/trabalhos/super-mario"/>
      ...
      <meta key="ogUrl" property="og:url" content="https://devdiegomatos.com.br/trabalhos/super-mario"/>
      ...
      <meta key="twitterUrl" name="twitter:url" content="https://devdiegomatos.com.br/trabalhos/super-mario"/>
    </Head>
  )
}